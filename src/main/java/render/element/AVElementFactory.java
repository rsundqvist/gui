...
public abstract class AVElementFactory {
     ...
     * @param e The element to bind to.
     * @param pri Primary size value, usually width.
     * @param sec Secondary size value, usually height. Sometimes ignored for shapes like
     * circles.
    ...
    /**
     * Creates the points for a relative polygon. Values in {@code points} are scaled
     * using the width and height arguments. All values in {@code points} should lie in
     * [0, 1].<br>
     * <p>
     * The original list is not changed.
     *
     * @param w The width of the polgyon.
     * @param h The height of the polgyon.
     * @param points Relative points for the polygon.
