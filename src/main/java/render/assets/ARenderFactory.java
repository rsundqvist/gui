...
/**
 * Convenience class for creating renders.
 *
...
public abstract class ARenderFactory {
     ...
     *
     * @param struct The DataStructure to create a Render for.
     * @param elemWidth Width for the elements.
     * @param elemHeight Height for the elements.
     * @param renderWidth Width for the render.
     * @param renderHeight Height for the render.
     * @return An {@code ARender} for {@code struct}.
     */
