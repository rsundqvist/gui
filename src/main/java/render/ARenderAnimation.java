...
public abstract class ARenderAnimation {
	...
	// @formatter:on
        ...
        ParallelTransition transition = Effect.buildTransition(orig, render, millis, effects);
	...
	// @formatter:on
        ...
        ParallelTransition pt = Effect.buildTransition(orig, render, millis, effects);
